...
#------------------BY-------------------------------#
#--------USING A WINDOW TO ENTER IPADRESS----------#
#--------CREATING THE WINDOW TO ENTER IPADDRESS----#
WindowTitle = 'Celebro-Chat v0.1 - Client'
HOST = HOST(text="please input ur external ipaddress here" , 
    title="CONNECTION VARIABLES" , defaultValue=""
    )
PORT = PORT(text="please input ur hosting port here" , 
    title="CONNECTION VARIABLES" , defaultValue=""
    )
